...
[![Docker Pulls](https://img.shields.io/docker/pulls/caesarlee888777/claude-relay-service)](https://hub.docker.com/r/caesarlee888777/claude-relay-service)
...
- 📝 **统一 Prompt 管理**: 集中管理 Codex、Claude Code、Droid 的系统提示词
- 🔄 **场景切换**: Codex 支持 default/gpt-5-codex/review 多种场景
- ⚙️ **灵活配置**: 环境变量控制 prompt 注入行为
- 🎯 **三级优先级**: 用户自定义 > 配置默认 > 不注入
